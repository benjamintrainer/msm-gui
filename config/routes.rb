Rails.application.routes.draw do
  ...
  post("/modify_director_record/:the_id", { :controller => "directors", :action => "modify" })
  ...
  post("/modify_movie_record/:the_id", { :controller => "movies", :action => "modify" })
  ...
  post("/modify_actor_record/:the_id", { :controller => "actors", :action => "modify" })
end
